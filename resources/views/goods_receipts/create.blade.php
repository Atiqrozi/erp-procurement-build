    ...
    <div class="max-w-xl mx-auto mt-8 bg-white shadow-lg rounded-lg p-8">
        ...
        <form method="POST" action="{{ route('goods-receipts.store', $purchaseOrder) }}">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="received_at" required class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 font-semibold mb-2">Penerima</label>
                <input type="text" name="receiver" required class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 font-semibold mb-2">Catatan</label>
                <textarea name="notes" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"></textarea>
            </div>
            <div class="mb-6">
            ...
            <button type="submit" class="w-full bg-blue-600 text-white font-semibold py-2 rounded hover:bg-blue-700 transition">Simpan</button>
        </form>
    </div>
</x-app-layout>